...
class Email:
    ...
    def send_email(self,email_address,v_code):
        self.smtp.sendmail('798637048@qq.com', email_address, self.message_bean(v_code).as_string())
        print('发送成功')
